			...
			<div className='mt-6 flex items-center'>
				<span className='flex min-w-0 flex-auto p-px'>
					<input
						...
						required
						className='w-full appearance-none rounded-[calc(var(--radius-md)-1px)] bg-zinc-700/[0.15] px-3 py-[calc(--spacing(2)-1px)] text-zinc-200 shadow-md shadow-zinc-800/5 outline outline-zinc-700 placeholder:text-zinc-500 focus:ring-4 focus:ring-teal-400/10 focus:outline-teal-400 sm:text-sm'
					/>
				</span>
...
function Role({ role }: { role: Role }) {
	...
	return (
		<li className='flex gap-4'>
			<div className='relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full border border-zinc-700/50 bg-zinc-800 shadow-md ring-0 ring-1 shadow-zinc-800/5 ring-zinc-900/5'>
